...
<form method="POST" action="{{route('obat.store')}}">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="form" placeholder="Enter Form" name="form">
  </div>
  <div class="form-group">
    <label for="restriction">Restriction Formula</label>
    <input type="text" class="form-control" id="restriction" placeholder="Enter Restriction Formula" name="restriction">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" id="faskes1" name="faskes1" min="0" max="1">
  </div>
  <div class="form-group">
    <label for="faskes2">Faskes2</label>
    <input type="number" class="form-control" id="faskes2" name="faskes2" min="0" max="1">
  </div>
  <div class="form-group">
    <label for="faskes3">Faskes3</label>
    <input type="number" class="form-control" id="faskes3" name="faskes3" min="0" max="1">
  </div>
